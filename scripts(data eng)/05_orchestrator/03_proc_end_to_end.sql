/*
==============================================================================
Stored Procedure: Load All Layers (Source -> Bronze -> Silver -> Gold)
==============================================================================
Script Purpose:
	This script loads all layers (Bronze, Silver, Gold).

Parameter: None

Usage: EXEC dbo.usp_end_to_end_pipeline;
==============================================================================
*/
CREATE OR ALTER PROCEDURE dbo.usp_end_to_end_pipeline AS
BEGIN
	-- Declare and map values to variables where necessary
	DECLARE
	@job_run_id INT,
	@job_name NVARCHAR(50) = 'dbo.usp_end_to_end_pipeline',
	@job_scope NVARCHAR(50) = 'END_TO_END',
	@start_time DATETIME,
	@end_time DATETIME,
	@job_duration INT,
